defmodule Customizer.TiledItems do
  @top_tiles ["acacia_door_top", "birch_door_top", "oak_door_top", "jungle_door_top", "spruce_door_top", "mangrove_door_top",
    "dark_oak_door_top", "iron_door_top", "crimson_door_top", "warped_door_top", "lilac_top", "peony_top", "rose_bush_top", "sunflower_top",
    "tall_grass_top"]

  @bottom_tiles ["acacia_door_bottom", "birch_door_bottom", "oak_door_bottom", "jungle_door_bottom",
    "spruce_door_bottom", "mangrove_door_bottom", "dark_oak_door_bottom", "iron_door_bottom", "crimson_door_bottom", "warped_door_bottom", "lilac_top", "lilac_bottom", "peony_bottom",
