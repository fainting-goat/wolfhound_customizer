...
#  http: [port: {:system, "8080"}],
#  url: [host: "localhost", port: {:system, "8080"}], # This is critical for ensuring web-sockets properly authorize.
...
# start per endpoint:
#
#     config :customizer, Customizer.Endpoint, server: true
#
